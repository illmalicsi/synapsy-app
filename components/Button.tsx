...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({ 
  ...
  const variants = {
    primary: "bg-indigo-600 text-white hover:bg-indigo-700 focus:ring-indigo-500 shadow-lg shadow-indigo-200 dark:shadow-indigo-900/30",
    secondary: "bg-teal-500 text-white hover:bg-teal-600 focus:ring-teal-400 shadow-lg shadow-teal-200 dark:shadow-teal-900/30",
